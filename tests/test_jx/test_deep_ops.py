...
class TestDeepOps(BaseTestCase):
    ...
    def test_bad_deep_select_column_w_groupby(self):
        test = {
            "data": [{"_a": {"b": "x"}}],  # WE NEED SOME DATA TO MAKE A NESTED COLUMN
            "query": {
                "from": TEST_TABLE,
    ...
    def test_select_whole_document(self):
        test = {
            ...
            "query": {"from": TEST_TABLE, "select": "*", "sort": ["o"]},
            "expecting_list": {
                "meta": {"format": "list"},
                "data": [
                    {"o": 1, "_a": {"b": "x", "v": 5}},
    ...
    def test_select_whole_nested_document(self):
        test = {
            ...
            "query": {"from": TEST_TABLE + "._a", "select": "*"},
            "expecting_list": {
                "meta": {"format": "list"},
                "data": [
                    {"o": 1, "b": "x", "v": 5},
    ...
    def test_deep_names_w_star(self):
        test = {
            ...
            "expecting_cube": {
                ...
                "data": {"a._t.b.s": [1, 2, 3], "a._t.h.s": ["a-a", "a-b", "a-c"]},
            },
        }
    ...
    def test_deep_agg_on_expression(self):
        ...
        test = {
            "data": [
                {"o": 3, "a": {"_a": [{"v": "a string"}, {"v": "another string"}]}},
            ...
            "es_query": {
                ...
                "aggs": {"_nested": {
                    "nested": {"path": "a._a"},
                    "aggs": {"max_length": {"max": {
                        "script": '(doc["v"].value).length()'
                    }}},
                }},
                "size": 10,
                "sort": [],
            },
            "expecting_list": {"meta": {"format": "value"}, "data": 14},
            "expecting_table": {
                "meta": {"format": "table"},
                "header": ["l"],
                "data": [[14]],
    ...
    def test_deep_agg_on_expression_w_shallow_where(self):
        ...
        test = {
            ...
            "expecting_list": {"meta": {"format": "value"}, "data": 10},
        }
    ...
    def test_setop_w_complicated_where(self):
        ...
        test = {
            ...
            "query": {
                "from": TEST_TABLE + ".a._a",
                "select": ["o", "v"],
                "where": {"and": [{"gte": {"o": 2}}, {"eq": {"s": False}}]},
            },
            "expecting_list": {
                "meta": {"format": "list"},
                "data": [{"o": 3, "v": "a string"}, {"o": 4}],
            },
        }
        ...
        test = {
            ...
            "expecting_list": {
                ...
                "data": [
                    {"o": 1, "a": {"_a": {"v": "still more",}}},
                    {"o": 2, "a": {"_a": {"v": "string!",}}},
                    {"o": 3, "a": {"_a": {"v": {"a string", "another string"}}}},
                ],
            },
        }
        self.utils.execute_tests(test)
    ...
    def test_id_select(self):
        ...
        test = {
            ...
            "query": {"select": ["_id"], "from": TEST_TABLE + ".a._a",},
            "expecting_list": {
                "meta": {"format": "list"},
                "data": [
                    {"_id": mo_math.is_hex},
    ...
    def test_aggs_on_parent(self):
        test = {
            ...
            "query": {"from": TEST_TABLE + ".a._a", "edges": ["o"]},
            "expecting_list": {
                "meta": {"format": "list"},
                "data": [
                    {"o": 1, "count": 1},
    ...
    def test_aggs_on_parent_and_child(self):
        test = {
            "data": [
                {"o": 1, "a": {"_a": [{"v": "b", "s": False}, {"v": "c"}]}},
                {"o": 1, "a": {"_a": {"v": "b", "s": False}}},
                {"o": 2, "a": {"_a": [{"v": "b", "s": True},]}},
                {"o": 2, "a": {"_a": {"s": False}}},
            ],
            "query": {
        ...
        test = {
            ...
            "expecting_cube": {
                ...
                "edges": [{
                    ...
                    "domain": {
                        "type": "set",
                        "partitions": [{"value": "a"}, {"value": "b"}, {"value": "c"}],
                    },
                }],
                "data": {"v.u": [3, NULL, 5, NULL]},
            },
        }
        self.utils.execute_tests(test)
    ...
    def test_shallow_and_ne_deep(self):
        test = {
            "data": [
                {"k": 1, "o": "a", "a": [{"v": "good", "s": False}, {"v": "bad"}]},
                {"k": 2, "o": "a", "a": [{"v": "good", "s": True},]},
                {"k": 3, "o": "a", "a": {"v": "bad", "s": False}},
                {"k": 4, "o": 4, "a": {"s": False}},
                {"k": 5, "o": "a"},
            ],
            "query": {
                "from": TEST_TABLE,
                "select": "k",
                "where": {"and": [{"eq": {"o": "a"}}, {"neq": {"a.v": "bad"}}]},
            },
            "expecting_list": {"meta": {"format": "list"}, "data": [1, 2]},
        }
        self.utils.execute_tests(test)
    ...
    def test_setop_w_deep_select_value(self):
        ...
        test = {
            ...
            "expecting_cube": {
                ...
                "data": {"v.u": [1, 2, 5, 6], "r.s": ["a", "a", "c", NULL]},
            },
        }
        self.utils.execute_tests(test)
    ...
    def test_deep_or(self):
        test = {
            ...
            "query": {
                "from": TEST_TABLE + ".a._b",
                "select": ["q.a", "q.b"],
                "where": {"or": [{"exists": "q.b"}, {"exists": "q.a"}]},
            },
            "expecting_list": {
                "meta": {"format": "list"},
                "data": [
    ...
    def test_sibling_nested_column(self):
        test = {
            ...
            "query": {"from": TEST_TABLE + ".a._b", "select": ["f"]},
            "expecting_list": {
                "meta": {"format": "list"},
                "data": [{"f": "a"}, {"f": "b"}],
            },
    ...
    def test_deep_star(self):
        ...
        test = {
            "data": [{
                "x": 1,
                "a": {"_b": [{"q": {"a": 0, "b": 1}}, {"q": {"a": 0}}, {"q": {}}]},
            }],
            "query": {"from": TEST_TABLE + ".a._b", "select": ["*"], "format": "list"},
            "expecting_list": {
                "meta": {"format": "list"},
                "data": [{"x": 1, "q.a": 0, "q.b": 1}, {"x": 1, "q.a": 0}, {"x": 1}],
            },
        }
        self.utils.execute_tests(test)
    ...
    def test_deep_select_dot(self):
        test = {
            "data": [
                {"x": 1, "_a": [{"b": "x", "v": 2}, {"b": "y", "v": 3}]},
                {"x": 2, "_a": {"b": "x", "v": 5}},
                {"_a": [{"b": "x", "v": 7},]},
                {"x": 3, "c": "x"},
            ],
            "query": {"from": TEST_TABLE + "._a", "select": {"value": "."},},
            "expecting_list": {
                "meta": {"format": "list"},
                "data": [
                    {"b": "x", "v": 2},
            ...
            "expecting_cube": {
                "meta": {"format": "cube"},
                "edges": [{
                    "domain": {"interval": 1, "max": 5, "min": 0, "type": "rownum"},
                    "name": "rownum",
                }],
                "data": {".": [
                    {"b": "x", "v": 2},
    ...
    def test_from_shallow_select_deep_column(self):
        ...
        test = {
            ...
            "query": {"from": TEST_TABLE, "select": "_a.b"},
            "expecting_list": {"meta": {"format": "list"}, "data": [[1, 3], [5, 7]]},
            "expecting_table": {
                "meta": {"format": "table"},
                "header": ["_a.b"],
                "data": [[[1, 3]], [[5, 7]]],
    ...
    def test_setop_w_shallow_eq_string(self):
        ...
        test = {
            "data": [
                {"o": 3, "a": [{"v": "a string", "s": False}, {"v": "another string"}]},
                {"o": "a", "a": [{"v": "string!", "s": True},]},
                {
                    "o": "a",
                    "a": {  # THIS IS SECONDS SO WE DO NOT HAVE BOTH INNER AND NESTED OBJECTS
                        "v": "still more",
                        "s": False,
                    },
                },
            ...
            "expecting_list": {
                "meta": {"format": "list"},
                "data": [{"o": "a", "v": "string!"}, {"o": "a", "v": "still more"}],
            },
        }
            ...
            "expecting_list": {
                ...
                "data": [
                    {"b": 1, "count": 2},
                    {
                        "b": 2,
                        "count": 1,
                    },  # v (at b==2) is multivalued: [4, 4] =>  is not null => {"when":"v", "then":1} == 1
                    {"b": 4, "count": 1},
                    {"count": 4},
                ],
            },
    ...
    def test_nested_document_selection(self):
        test = {
            "data": [
                [{"b": "x", "v": [{"k": 1}, {"k": 2}]}, {"b": "y", "v": [{"k": "3"}]}],
                {"b": "x", "v": [{"k": 5}]},
                [{"b": "x", "v": [{"k": 7}]},],
                [],
                [{"m": 1}],
            ],
            "query": {"select": ["b", "v"], "from": TEST_TABLE, "format": "list"},
            "expecting_list": {
                "meta": {"format": "list"},
                "data": [
                    {"b": "x", "v": [{"k": 1}, {"k": 2}]},
