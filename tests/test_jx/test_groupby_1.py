...
class TestgroupBy1(BaseTestCase):
    def test_no_select(self):
        test = {
            ...
            "query": {"from": TEST_TABLE, "groupby": "a"},
            "expecting_list": {
                "meta": {"format": "list"},
                "data": [
                    {"a": "b", "count": 2},
    ...
    def test_default(self):
        test = {
            ...
            "expecting_list": {
                "meta": {"format": "list"},
                "data": [{"a": "b", "v": 2}, {"a": "c", "v": 0}, {"a": NULL, "v": 3}],
            },
            "expecting_table": {
                "meta": {"format": "table"},
                "header": ["a", "v"],
            ...
            "expecting_cube": {
                ...
                "edges": [{
                    "name": "a",
                    "domain": {"partitions": [{"value": "b"}, {"value": "c"}]},
                }],
                "data": {"v": [2, 0, 3]},
            },
        }
    ...
    def test_many_aggs_on_one_column(self):
        ...
        test = {
            # d = {"a": a, "v", v}
            "data": [
                {"a": {"b": {"c": d.v}}, "b": d.a} for d in to_data(simple_test_data)
            ],
            "query": {
                "from": TEST_TABLE,
                "select": [
    ...
    @skipIf(
        global_settings.elasticsearch.version.startswith("5."), "Not supported by es5"
    )
    def test_groupby_left_id(self):
        test = {
            "data": [
                set_default(d, {"_id": "aa" + text(i)})
                for i, d in enumerate(simple_test_data)
            ],
            "query": {
                "from": TEST_TABLE,
    ...
    @skipIf(global_settings.use in ("sqlite", "elasticsearch"), "requires subqueries")
    ...
    @skipIf(global_settings.use in ("sqlite", "elasticsearch"), "for coverage")
    def test_groupby_multivalue_nested(self):
        test = {
            ...
            "expecting_table": {
                "meta": {"format": "table"},
                "header": ["b", "count"],
                "data": [[1, 1], [2, 2], [3, 3], [4, 3], [5, 2], [6, 2], [NULL, 1]],
            },
        }
        self.utils.execute_tests(test)
    ...
    def test_groupby_object(self):
        test = {
            ...
            "query": {"from": TEST_TABLE, "groupby": ["g"]},
            "expecting_list": {
                "meta": {"format": "list"},
                "data": [
                    {"g": {"a": "b", "v": 1}, "count": 2},
    ...
    @skipIf(global_settings.use in ("sqlite", "elasticsearch"), "requires groupby sets")
    def test_groupby_multivalue_naive(self):
        test = {
            ...
            "query": {"from": TEST_TABLE, "groupby": ["r.t"]},
            "expecting_list": {
                "meta": {"format": "list"},
                "data": [
                    {"r": {"t": ["a", "b"]}, "count": 2},
    ...
    def test_script_on_missing_column1(self):
        test = {
            ...
            "expecting_list": {"meta": {"format": "value"}, "data": 0},
            "expecting_table": {"header": ["skips"], "data": [[0]]},
        }
        self.utils.execute_tests(test)
    ...
    def test_boolean_count(self):
        test = {
            ...
            "expecting_list": {"meta": {"format": "value"}, "data": 1},
            "expecting_table": {"header": ["skips"], "data": [[1]]},
        }
        self.utils.execute_tests(test)

    def test_boolean_min_max(self):
        test = {
            "data": [{"a": True}, {"a": False}, {"a": False}, {"a": None}, {},],
            "query": {
                "from": TEST_TABLE,
                "select": [
                    {"name": "max", "value": "a", "aggregate": "max"},
                    {"name": "min", "value": "a", "aggregate": "min"},
                    {"name": "or", "value": "a", "aggregate": "or"},
                    {"name": "and", "value": "a", "aggregate": "and"},
                ],
            },
            "expecting_list": {
                "meta": {"format": "value"},
    ...
    def test_eq_1(self):
        test = {
            ...
            "expecting_list": {
                "meta": {"format": "list"},
                "data": [{"eq1": True, "count": 1}, {"eq1": False, "count": 4}],
            },
            "expecting_table": {
                "header": ["eq1", "count"],
                "data": [[True, 1], [False, 4]],
