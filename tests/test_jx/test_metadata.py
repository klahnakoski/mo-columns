...
class TestMetadata(BaseTestCase):
    ...
    def test_meta_tables(self):
        ...
        test = {
            "query": {"from": META_TABLES_NAME, "where": {"eq": {"name": table_name}}},
            "expecting_list": {
                "meta": {"format": "list"},
    ...
    @skipIf(global_settings.use in ("sqlite", "elasticsearch"), "broken")
    def test_meta(self):
        test = dict_to_data({"query": {"from": TEST_TABLE}, "data": [{"a": "b"}]})
    ...
    def test_cardinality(self):
        ...
        test = {
            ...
            "expecting_list": {"meta": {"format": "list"}, "data": [2]},
        }
